...
values ('ssar', '$2a$10$LACXclDpbAvdikOzSEnC4uq230Llj0bawhtZr4Sd596P5ZUwHB06S', 'ssar@nate.com', now());
insert into user_tb(username, password, email, created_at)
values ('cos', '$2a$10$LACXclDpbAvdikOzSEnC4uq230Llj0bawhtZr4Sd596P5ZUwHB06S', 'cos@nate.com', now());
insert into user_tb(username, password, email, created_at)
values ('love', '$2a$10$LACXclDpbAvdikOzSEnC4uq230Llj0bawhtZr4Sd596P5ZUwHB06S', 'love@nate.com', now());
